...
def lastmatches_info(matches, id):
    ...
    """
    matches_data = [[],{}]
    queue_type = {400:"Normal reclutamiento", 420:"SoloQ", 430:"Normal", 440:"Flexible", 450:"Aram", 720:"Clash Aram", 1700:"Arena 2v2"}
        ...
        if response.status_code == 200:
            ...
            if y != 1700:
                ...
                if champ in matches_data[1]["champs_used"]:
                    ...
                    matches_data[1]["champs_used"][champ]["kda"] = float(format(matches_data[1]["champs_used"][champ]["kda"], ".2f"))
                    if data["win_b"]:
    ...
    if response.status_code == 200:
        ...
        for info in data:
            if info["queueType"] != "CHERRY":
                ...
                info["tier"] = info["tier"].capitalize()
